...
func (w WebHookEndpoint) GetList() func(http.ResponseWriter, *http.Request) {
	db := w.db
...
func (w WebHookEndpoint) Insert() func(http.ResponseWriter, *http.Request) {
	db := w.db
	router := w.router
	return func(w http.ResponseWriter, r *http.Request) {
...
func (w WebHookEndpoint) GetOne() func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
